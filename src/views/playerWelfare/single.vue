        ...
        <div class="ml10 box-cardMain">
            ...
            <div class="body">
              <div class="mb10">
                <el-radio-group v-model="filters.radio" @change="radioChange">
                  ...
                  <el-radio-button :label="3">未发完</el-radio-button>
              ...
              >
                ...
                <el-table-column prop="putOutStatusStr" label="发放状态">
                  <template slot-scope="scope">
                    ...
                    <div>
                      ...
                      <div>
                        <el-button
                          type="text"
                          v-if="
                            scope.row.putOutStatus === 2 ||
                              scope.row.putOutStatus === 3
                          "
                          @click="sendGift2(scope.row)"
                          style="color: red"
                          >发放礼包</el-button
                        >
                      </div>
          ...
          >
            <el-form label-width="120px">
              ...
              <el-form-item label="代发放数量：">
                {{ dialogForm.reachNum - dialogForm.receiveNum }}
              </el-form-item>
              <el-form-item label="发放数量：">
                <el-input
                  type="number"
                  min="1"
                  v-model.number="sendNum"
                  :max="dialogForm.reachNum - dialogForm.receiveNum"
                  style="width: 100px"
                ></el-input>
              </el-form-item>
              <el-form-item label="">
                <el-button type="primary" @click="handleSendGift2"
                  >发放礼包</el-button
                >
              </el-form-item>
            </el-form>
...
export default {
  ...
  methods: {
    ...
    sendGift2(row) {
      ...
      this.sendNum = this.dialogForm.reachNum - this.dialogForm.receiveNum;
    },
    //发放礼包提交
    async handleSendGift2() {
      if (
        this.sendNum >
        this.dialogForm.reachNum - this.dialogForm.receiveNum
      ) {
        this.$message.error("发送礼包数量超过代发放数量！");
        return false;
      }
      let data = {
        id: this.dialogForm.id,
        putOutNum: this.sendNum
      };
      try {
        const res = await http.post2("/game/grantGiftSingle.do", data);
        if (res.state == "ok") {
    ...
    getGuildGiftList() {
      const data = {
        TargetConditionType: 4, //1=每日福利，3=累计累充福利，4=单笔福利列表，5=单日累充福利，6=等级福利列表
